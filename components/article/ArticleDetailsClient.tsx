...
import { stagger, useAnimate, useInView, animate } from "framer-motion";
...
const ArticleDetailsClient = ({
  ...
  const onButtonClick = () => {
    ...
    // animate("#bubble", { opacity: 1, y: -40 }, { duration: 1 });
    // animate("#bubble", { opacity: [1, 0], y: -80 }, { delay: 1, duration: 1 });
    // animate("#bubble", { opacity: [1, 0], y: -40 }, { duration: 1.5 });
        ...
        <div className="flex items-center gap-3">
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            <SheetContent className="flex flex-col gap-5 overflow-y-auto">
              <SheetHeader>
                <SheetTitle>Responses ({article?.comments?.length})</SheetTitle>
              </SheetHeader>
            ...
            <DropdownMenuTrigger>
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <div className="flex items-center gap-3 text-sm">More</div>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </DropdownMenuTrigger>
